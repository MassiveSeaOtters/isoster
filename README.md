...
- **High performance**: tens of times faster than `photutils.isophote` via vectorized sampling (median $46\times$ on the synthetic Sérsic sweep; see above).
