"""
Benchmark: Synthetic Gaussian Profile with Noise

Tests the optimized isophote fitting on a synthetic Gaussian intensity
profile with added Gaussian noise (sigma=1.0). Compares performance and
accuracy against photutils.isophote.
"""
...
from isoster.plotting import plot_isophote_comparison, calculate_accuracy_metrics


def create_synthetic_image(shape=(500, 500), x0=250, y0=250, eps=0.4, pa=1.0, sigma=50, noise_sigma=1.0):
    """Create a synthetic Gaussian profile image."""
...
def main():
    print("=" * 70)
    print("Benchmark: Synthetic Gaussian Profile with Noise (sigma=1.0)")
    print("=" * 70)
    
    # Create synthetic image
    print("\nGenerating synthetic image...")
    image = create_synthetic_image(noise_sigma=1.0)
    ...
    plot_isophote_comparison(
        "Synthetic Gaussian Profile (Noise sigma=1.0)",
