...
The full suite is 917 passing (5 deselected) as of 2026-08-20; regenerate with `uv run pytest tests/ --collect-only -q | tail -2` rather than trusting this figure.
