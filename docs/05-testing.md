...
|---|---:|---|
| `unit/` | 343 | Module behaviour and API contracts; fast, no I/O |
...
As of 2026-08-21 pytest discovers 946 tests and deselects 5, leaving 941
selected; a full run reports 940 passed and 1 skipped. These figures drift —
