...
|---|---:|---|
| `unit/` | 324 | Module behaviour and API contracts; fast, no I/O |
...
As of 2026-08-21 pytest discovers 927 tests and deselects 5, leaving 922
selected; a full run reports 921 passed and 1 skipped. These figures drift —
